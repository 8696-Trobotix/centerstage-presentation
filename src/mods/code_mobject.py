# Copied from: https://github.com/TimeTravelPenguin/manim/blob/e9cc73c74177faeb28213b78f8db583ad3a34305/manim/mobject/text/code_mobject.py
...
def lex2csw(code: str, lexer: Lexer | LexerMeta, style_name: str = "default"):
    ...
    p1 = iter(lexed_code)
    p2 = iter(lexed_code)
    for token, value in p1:
        try:
            next_token, _ = next(p2)
        except:
            next_token, _ = (None, None)
