...
import org.firstinspires.ftc.teamcode.squid.gamma.subsystems.*;
import org.firstinspires.ftc.teamcode.squid.gamma.mollusc.auto.odometry.*;
...
public class SquidWare {
    ...
    public SquidWare(Configuration config, boolean resetIMU) throws Exception {
        ...
        Encoder leftEncoder = new Encoder("leftEncoder", -1.0, TPR, 35);
        // rightEncoder = new Encoder("rightEncoder", 1.0, TPR, 35);
        // centerEncoder = new Encoder("centerEncoder", 1.0, TPR, 35);
